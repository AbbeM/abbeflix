...
var rateMovie = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(movieId, addBtn) {
    var res;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          res = _context5.sent;
          if (res.data.status == 'success') (0, _alerts.showAlert)('success', 'Rated');
          addBtn.textContent = 'Ta Bort';
          _context5.next = 11;
          break;
        case 8:
  ...
  return function rateMovie(_x9, _x10) {
...
if (rateBtn) {
  rateBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var movieId = e.target.getAttribute('movieId');
    (0, _auth.rateMovie)(movieId, e.target);
  });
}
