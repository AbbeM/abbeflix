...
},{}],"../../node_modules/jwt-decode/build/jwt-decode.esm.js":[function(require,module,exports) {
"use strict";
...
exports.sigup = exports.rateMovie = exports.logout = exports.login = exports.addToFavorit = void 0;
...
var token = localStorage.getItem('jwt'); // Hämta JWT-token från localStorage
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Du är inloggad!');
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'inloggningen misslyckades');
        case 10:
        case "end":
...
var sigup = /*#__PURE__*/function () {
  ...
  return function sigup(_x3, _x4, _x5, _x6) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'misslyckades');
        case 10:
        case "end":
...
var addToFavorit = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(movieId, addBtn) {
    var favoritMovie, res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/movies/".concat(movieId)
          });
        case 3:
          favoritMovie = _context4.sent;
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "http://127.0.0.1:8000/api/v1/movies/".concat(movieId, "/favorits")
          });
        case 7:
          res = _context4.sent;
          if (res.data.status == 'success') (0, _alerts.showAlert)('success', 'Added to list');
        ...
        case 14:
          (0, _alerts.showAlert)('success', 'Deleted from list');
  ...
  return function addToFavorit(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
exports.addToFavorit = addToFavorit;
var rateMovie = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(movieId, user, rating) {
    var res, review, updateRes, createRes;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/movies/".concat(movieId, "/reviews")
          });
        case 3:
          res = _context5.sent;
          // Kolla om användaren har betygsatt filmen tidigare
          review = res.data.data.docs.find(function (review) {
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8000/api/v1/movies/".concat(movieId, "/reviews/").concat(review.id),
            data: {
              rating: rating
            }
          });
        case 8:
          ...
          if (updateRes.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Rating updated');
          }
          _context5.next = 16;
          break;
        case 12:
        ...
        case 14:
          ...
          if (createRes.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Rated');
          }
        case 16:
          _context5.next = 21;
          break;
  ...
  return function rateMovie(_x9, _x10, _x11) {
    return _ref5.apply(this, arguments);
  };
}();
exports.rateMovie = rateMovie;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","jwt-decode":"../../node_modules/jwt-decode/build/jwt-decode.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
// BTNS
var settingsBtn = document.querySelector('.profile-btns.settings');
var resPassBtn = document.querySelector('.profile-btns.pass');
var registerBtn = document.querySelector('.register');
var loginBtn = document.querySelector('.login-link');
var nxtBtn = document.querySelector('.nxtBtn');
var brvBtn = document.querySelector('.brvBtn');
var regbtns = document.querySelectorAll('.regbtns input');
var logoutbtnA = document.querySelector('#loggaut');
var addToListBtn = document.querySelector('.add-to-list');
var rateBtn = document.querySelector('.rate');

// ELEMENTS
var step1Elements = document.querySelectorAll('.step-1');
var step2Elements = document.querySelectorAll('.step-2');
var steps = document.querySelectorAll('.step');
var stars = document.querySelectorAll('.rate svg');
var rating = document.querySelector('.rate p').getAttribute('rating');

// LAYOUTS
var layout = document.querySelectorAll('.layout');
var settingsLayout = document.querySelector('.layout.settings');
var passLayout = document.querySelector('.layout.pass');
...
function validate(field, regex, e) {
  if (regex.test(field.value)) {
    ...
    document.querySelector("#".concat(field.attributes.name.value, "-err")).style.display = 'none';
  } else {
    loginError = true;
    field.className = 'invalid';
    document.querySelector("#".concat(field.attributes.name.value, "-err")).style.display = 'inline-block';
  }
}
...
// DS was here ;-)
if (resPassBtn) {
  resPassBtn.addEventListener('click', function () {
    layout.forEach(function (el) {
      el.classList.remove('active');
    });
...
if (signupForm) {
  ...
  brvBtn.addEventListener('click', function (e) {
    step2Elements.forEach(function (el) {
      if (!el.classList.contains('err')) {
        el.style.display = 'none';
      }
  ...
  signupForm.addEventListener('submit', function (e) {
    ...
    if (!loginError) {
      ...
      var pass = signupForm.pass.value;
      var passConf = signupForm.passConf.value;
      (0, _auth.sigup)(name, email, pass, passConf);
    }
  });
}
if (logoutbtnA) {
  logoutbtnA.addEventListener('click', function (e) {
    (0, _auth.logout)();
  });
}
if (addToListBtn) {
  addToListBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var movieId = e.target.getAttribute('movieId');
    (0, _auth.addToFavorit)(movieId, e.target);
  });
}
...
if (stars) {
  stars.forEach(function (item, index1) {
    item.addEventListener('click', function (e) {
      var movieId = e.target.getAttribute('movieid');
      var user = e.target.getAttribute('currentuser');
      (0, _auth.rateMovie)(movieId, user, (index1 + 1) * 2);
